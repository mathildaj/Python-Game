...
def draw(canvas):
    global time, started, rock_group, lives, missile_group, score, rocks, explosion_group
    ...
    # determine whether rocks collide with the ship
    if group_collide(rock_group, my_ship):
        lives -= 1
        
    # detect missile and rock collision and update score   
